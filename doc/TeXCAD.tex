...
% File name: [Clipboard].
% Version of TeXCAD: 4.5 Preview
% Reference / build: 05-Sep-2015 (rev. a54+)
...
\footnotesize
\framebox{\input{../test_io/texcads.tcp}}
\end{minipage}
}
...
and is fully mirrored at \hrefid{https://github.com/zertovitch/texcad}.
%
...
To build {\TC} from the sources, you have two ways:
  \begin{itemize}
    \item Using Alire (\hrefid{https://alire.ada.dev/}), commands: alr get texcad, cd texcad*, alr build \\
...
GNU Ada compiler (GNAT) that can be found there:
  \hrefid{https://www.adacore.com/download} \\
Alternatively you can use the "Free Software Foundation (FSF)" version, via Alire: \hrefid{https://alire.ada.dev/}.
...
\begin{enumerate}
  ...
  \item Then you need the GNAVI/GWindows framework that you'll find at one of the following places:\\
        \hrefid{http://sourceforge.net/projects/gnavi/} or\\
        \hrefid{https://github.com/zertovitch/gwindows}.
  ...
  \item Third step is getting the Mathpaqs repository\\
        \hrefid{http://sourceforge.net/projects/mathpaqs/} or \\
        \hrefid{https://github.com/zertovitch/mathpaqs}.
        Installation of the latter is optional.
        It is sufficient to unpack or get the sources via git or svn or
        extract them from a zip file.
