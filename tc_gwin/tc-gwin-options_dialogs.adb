...
package body TC.GWin.Options_Dialogs is
  ...
  overriding procedure On_Click (Button : in out Special_Check_Box_Type);

  overriding procedure State (Button    : in out Special_Check_Box_Type;
  ...
  overriding procedure On_Click (Button : in out Special_Check_Box_Type) is
  begin
  ...
  is
    ...
    original_opt : constant TC.General_Options := gen_opt;
    candidate    :          TC.General_Options := original_opt;
