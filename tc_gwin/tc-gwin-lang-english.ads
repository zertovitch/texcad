package TC.GWin.Lang.English is
  ...
  m : constant Message_set :=
        ...
        (empty      => U (""),
         ...
         cannotbackup =>
                       U ("Unable to replace the bakup copy (read-only ?)"),
         open       => U ("Open..."),
         mcancel    => U ("Cancel"),
         save       => U ("Save"),
         save_as    => U ("Save as"),
         ...
         param2d_title     => U ("2D Parametric curve"),
         param2d_segments  => U ("Segments (0=auto)"),
         param2d_scale     => U ("Scale"),
         ...
         cleanup     => U ("Cleanup"),
         cleanup_selected =>
                        U ("Cleanup selected topics"),
         topic       => U ("Topic"),
         occurrences => U ("Occurrences"),
         first_pos   => U ("First position"),
         clean_empty_text         => U ("Empty text"),
         clean_zero_sized_object  => U ("Zero sized object"),
         clean_unknown_command    => U ("Command unkown to TeXCAD"),
