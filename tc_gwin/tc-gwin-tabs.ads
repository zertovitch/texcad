...
package TC.GWin.Tabs is
  ...
  overriding procedure On_Change (Control : in out TeXCAD_Tab_Bar_Type);
  overriding procedure On_Create (Control : in out TeXCAD_Tab_Bar_Type);
  ...
  overriding procedure On_Middle_Click (Control : in out TeXCAD_Tab_Bar_Type);
  overriding procedure On_Right_Click (Control : in out TeXCAD_Tab_Bar_Type);

  overriding procedure Delete_Tab (Control : in out TeXCAD_Tab_Bar_Type; Where : in Integer);

  function Tab_Index (Control : in out TeXCAD_Tab_Bar_Type; ID : ID_Type) return Integer;
